...
import { complaintEmailTemplate } from "../Templates/Complaints.js";
...
const index = async (req, res) => {
  ...
  try {
    let result = await StudentComplaint.find({
      createdBy: req.params.id,
      deleted: false,
    });
    console.log("result=>", result);

    let total_recodes = await StudentComplaint.countDocuments({
      createdBy: req.params.id,
      deleted: false,
    });
