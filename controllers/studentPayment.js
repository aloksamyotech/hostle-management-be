...
// import { paymentEmailTemplate } from "../Templates/payment.js";
  ...
  try {
    ...
    if (isFirstMonth) {
      ...
      if (startDay > 1) {
        ...
        console.log(
          " Student joined before the 15st, full month charge applied."
        );
      }
    } else {
      adjustedMonthlyAmount = baseMonthlyAmount;
    ...
    if (latestPayment) {
      ...
      if (latestPayment.month === month) {
        console.log("name which is coming or not", latestPayment);
        monthlyPending = latestPayment.monthlyPending - actualPaymentAmount;
      } else {
        monthlyPending =
          adjustedMonthlyAmount -
